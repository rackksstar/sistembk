...
**Terakhir diperbarui:** 2026-07-10 (audit sync + polish tampilan core)
...
| Tanggal    | Update                                                 |
| ---------- | ------------------------------------------------------ |
| 2026-07-10 | Sync kelas + harden akses guru, ringkasan penilaian akurat, polish UI dark mode & CTA siswa |
