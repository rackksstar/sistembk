<x-guest-layout>
    <div class="space-y-8">
        <div class="space-y-3 text-center">
            ...
            <h1 class="text-3xl font-semibold text-slate-950 dark:text-white sm:text-4xl">Akses area aman</h1>
            <p class="text-sm leading-6 text-slate-600 dark:text-slate-400">Masukkan password Anda untuk melanjutkan.</p>
        </div>
