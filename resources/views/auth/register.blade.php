<x-guest-layout role="siswa">
    <div class="space-y-8">
        <div class="space-y-3 text-center">
            ...
            <h1 class="text-3xl font-semibold text-slate-950 dark:text-white sm:text-4xl">Mulai akses layanan BK</h1>
            <p class="text-sm leading-6 text-slate-600 dark:text-slate-400">Akun siswa bisa langsung digunakan untuk pengajuan konseling.</p>
        </div>

        <div class="rounded-2xl border border-blue-100 dark:border-blue-900/50 bg-blue-50 dark:bg-blue-950/40 px-4 py-3 text-sm leading-6 text-blue-700 dark:text-blue-300">
