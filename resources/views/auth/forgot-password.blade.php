<x-guest-layout>
    <div class="space-y-8">
        <div class="space-y-3 text-center">
            ...
            <h1 class="text-3xl font-semibold text-slate-950 dark:text-white sm:text-4xl">Lupa password?</h1>
            <p class="text-sm leading-6 text-slate-600 dark:text-slate-400">Masukkan email Anda dan kami akan mengirimkan instruksi reset password.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
            ...
            <p class="text-center text-sm text-slate-600 dark:text-slate-400">Ingat password? <a href="{{ route('login') }}" class="font-semibold text-blue-600 hover:text-blue-500">Login</a></p>
        </form>
    </div>
</x-guest-layout>
