            ...
            <article class="overflow-hidden rounded-3xl border border-blue-100 dark:border-blue-900/50 bg-white dark:bg-slate-900 shadow-sm transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-100">
                ...
                <div class="space-y-4 p-5">
                    <div>
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-slate-950 dark:text-white">{{ $career->title }}</h3>
                        <p class="mt-2 line-clamp-3 text-sm leading-6 text-slate-600 dark:text-slate-400">{{ $career->description }}</p>
                    </div>
                    <div class="flex gap-2">
                        <button type="button" x-on:click="editOpen = {{ $career->id }}" class="flex-1 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-4 py-2 text-sm font-semibold text-slate-700 dark:text-slate-300 transition hover:bg-slate-50 dark:hover:bg-slate-800/60">Edit</button>
