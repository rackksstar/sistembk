                        ...
                        <tr>
                            ...
                            <td class="px-5 py-4">
                                <div class="flex gap-2">
                                    <button type="button" x-on:click="editOpen = {{ $question->id }}" class="rounded-xl border border-slate-200 dark:border-slate-700 px-3 py-2 font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/60">Edit</button>
