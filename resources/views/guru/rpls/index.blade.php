            ...
            <article class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type="button" x-on:click="editOpen = {{ $rpl->id }}" class="rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">Edit</button>
                    </div>
                </div>
                <div class="mt-5 grid gap-3 md:grid-cols-2">
                    ...
                    <div class="rounded-2xl bg-slate-50 p-4"><p class="font-semibold text-slate-900">Evaluasi</p><p class="mt-1 line-clamp-3 text-sm leading-6 text-slate-600">{{ $rpl->evaluasi }}</p></div>
                </div>
