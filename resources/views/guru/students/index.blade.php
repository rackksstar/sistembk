    ...
    <section class="rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div class="flex flex-wrap gap-3">
                <button x-on:click="importOpen = true" class="w-fit rounded-2xl border border-blue-200 dark:border-blue-800 bg-white dark:bg-slate-900 px-5 py-3 text-sm font-semibold text-blue-700 dark:text-blue-300 hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-blue-950/40">Import CSV</button>
                            ...
                            <tr>
                                <td colspan="6" class="px-5 py-6">
                                    ...
                                    <div class="mt-4 flex flex-wrap justify-center gap-2">
                                        ...
                                        <button type="button" x-on:click="importOpen = true" class="rounded-2xl border border-blue-200 dark:border-blue-800 px-5 py-3 text-sm font-semibold text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-950/40">Import CSV</button>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
